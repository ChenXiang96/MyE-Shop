  ...
  <body class="animsition">
    <div class="about" id="page">
      ...
      <section class="sub-header shop-layout-1">
        <img class="rellax bg-overlay" src="${pageContext.request.contextPath}/picture/fod.jpg" alt="">
        <div class="overlay-call-to-action"></div>
        <h3 class="heading-style-3">关于我们</h3>
        ...
        <div class="container">
          <div class="row blog-v reverse">
            <div class="col-md-12">
              <div class="post">
                <div class="img-wrapper js-set-bg-blog-thumb">
                  <img src="${pageContext.request.contextPath}/picture/01.jpg" alt="blog-thumb">
                </div>
                <div class="desc">
                  <h3 class="title-about">Who We Are</h3>
                  <p class="sapo">We are a manufacturing base of organic food produced on our farm. We are a family health care production team, created by today's need for clean and safe food, driven by the desire to build meaningful and meaningful experiences. Vivamus
            ...
            <div class="col-md-12">
              <div class="post">
                <div class="img-wrapper js-set-bg-blog-thumb">
                  <img src="${pageContext.request.contextPath}/picture/02.jpg" alt="blog-thumb">
                </div>
                <div class="desc">
                  <h3 class="title-about">What We Do</h3>
                  <p class="sapo">We provide all kinds of organic products. Produced on our farm, the products are always fresh, multi-vitamins, rich variety for your family. With our organic food will bring delicious meals to your family.</p>
      ...
      <section>
        <div class="counter-wrapper">
          <img class="rellax bg-overlay" src="${pageContext.request.contextPath}/picture/4.jpg" alt="" />
