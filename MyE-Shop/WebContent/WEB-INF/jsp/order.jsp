  ...
  <body class="animsition">
    <div class="checkout" id="page">
      ...
      <section class="sub-header shop-detail-1">
        <img class="rellax bg-overlay" src="${pageContext.request.contextPath}/picture/015.jpg" alt="">
                  ...
                  <div class="payment_method_paypal">
                    <div class="radio">
                      <label>
                        ...
                        <img src="${pageContext.request.contextPath}/picture/paypal-group-icon.png" alt="paypal">
            ...
            <div class="copy-right-inner">
              ...
              <div class="widget widget-footer widget-footer-creadit-card">
                <ul class="list-unstyle">
                  ...
                  <li>
                    <a href="#">
                      <img src="${pageContext.request.contextPath}/picture/creadit-card-02.png" alt="creadit card" />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="${pageContext.request.contextPath}/picture/creadit-card-03.png" alt="creadit card" />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="${pageContext.request.contextPath}/picture/creadit-card-04.png" alt="creadit card" />
                    </a>
                  </li>
                </ul>
              </div>
