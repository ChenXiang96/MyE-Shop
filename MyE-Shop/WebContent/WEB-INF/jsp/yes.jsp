...
<html>
  ...
  <body class="animsition">
      ...
      <section class="boxed-sm section-404-wrapper">
        <div class="container">
          ...
          <div class="call-to-action-style-1">
            <h2><font color="#A2CD5A">注册成功!</font></h2>
             <p class="h3"><font color="#A2CD5A">请去邮箱激活您的账户</font></p>
             <a class="btn btn-brand pill" href="${ pageContext.request.contextPath }/index.action">返回首页</a>
             <a class="btn btn-brand pill" href="${ pageContext.request.contextPath }/user_registPage.action">返回注册</a>
             <a class="btn btn-brand pill" href="${ pageContext.request.contextPath }/user_loginPage.action">返回登录</a>
   ...
   <%@ include file="footer.jsp" %>
    ...
    <script src="${pageContext.request.contextPath}/js/0aee2109a6234e989c7511d5932dc2ac.js"></script>
    <script src="${pageContext.request.contextPath}/js/config-google-map.js"></script>
  </body>
</html>
